...
class EncoderLayer_mHC(nn.Module):
    """
    Autoformer encoder layer with mHC stream topology.
    """
    ...
    def __init__(
        ...
        self.residual_mix = mHCResidualMix(num_streams, sinkhorn_iters)
...
class Encoder_mHC(nn.Module, AutoformerStreamMixin):
    def __init__(
        self,
        attn_layers,
        d_model,
...
class DecoderLayer_mHC(nn.Module):
    """
    Autoformer decoder layer with mHC stream topology.
    """
...
class Decoder_mHC(nn.Module, AutoformerStreamMixin):
    def __init__(
        self,
        layers,
        d_model,
